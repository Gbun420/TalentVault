...
export interface ApiApplicationApplication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.Enumeration<['platform', 'external', 'referral']> &
...
export interface ApiCandidateProfileCandidateProfile
  ...
  attributes: {
    ...
    availability: Schema.Attribute.Enumeration<
      ['immediate', 'two_weeks', 'one_month', 'three_months', 'open']
    > &
      Schema.Attribute.DefaultTo<'open'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    desiredSalary: Schema.Attribute.Component<'shared.salary-range', false>;
    ...
    unlocks: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-unlock.contact-unlock'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    workExperience: Schema.Attribute.Component<'profile.work-experience', true>;
...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'name'>;
    socials: Schema.Attribute.Component<'profile.social-link', true>;
...
export interface ApiContactUnlockContactUnlock
  extends Struct.CollectionTypeSchema {
  collectionName: 'contact_unlocks';
  info: {
    displayName: 'Contact Unlock';
    pluralName: 'contact-unlocks';
    singularName: 'contact-unlock';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['pending', 'unlocked', 'revoked']> &
...
export interface ApiEmployerEmployer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactUnlocks: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-unlock.contact-unlock'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['owner', 'admin', 'recruiter']> &
      Schema.Attribute.DefaultTo<'recruiter'>;
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    remoteType: Schema.Attribute.Enumeration<['onsite', 'hybrid', 'remote']> &
      Schema.Attribute.DefaultTo<'hybrid'>;
    requirements: Schema.Attribute.Blocks;
    responsibilities: Schema.Attribute.Blocks;
    salaryRange: Schema.Attribute.Component<'shared.salary-range', false>;
    skills: Schema.Attribute.Relation<'manyToMany', 'api::skill.skill'>;
    slug: Schema.Attribute.UID<'title'>;
    status: Schema.Attribute.Enumeration<['open', 'closed', 'filled']> &
      Schema.Attribute.DefaultTo<'open'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentType: Schema.Attribute.Enumeration<['subscription', 'unlock']>;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
...
export interface ApiSubscriptionPlanSubscriptionPlan
  ...
  attributes: {
    ...
    featuredPosts: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    interval: Schema.Attribute.Enumeration<['month', 'year']> &
      Schema.Attribute.DefaultTo<'month'>;
    jobPostLimit: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    subscriptions: Schema.Attribute.Relation<
      ...
      'api::subscription.subscription'
    >;
    unlocksIncluded: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contact-unlock.contact-unlock': ApiContactUnlockContactUnlock;
